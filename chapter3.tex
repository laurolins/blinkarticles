...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=12.5cm]{fig/BFL2Blink.pdf}\\
   \end{center}
   \vspace{-0.7cm}
...
Follow the s.pdf described in this paragraph on the example of
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=9cm]{fig/BlinksPlaneIsotopy.pdf}
   \end{center}
   \vspace{-0.7cm}
   \caption{Blinks}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=10cm]{fig/blinkCalculusOnCoins.pdf}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=10cm]{fig/mun.pdf}
   \end{center}
   \vspace{-0.7cm}
...
ribbon move.
\begin{center}
\includegraphics[width=6cm]{fig/heartSmoothing.pdf}
\end{center}
\end{Lem}
...
\begin{center}
\includegraphics[width=12cm]{fig/heartSmoothingProof.pdf}
\end{center}
\vspace{-0.8cm}
\end{proof}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=9cm]{fig/MuNproof.pdf}
   \end{center}
   \vspace{-0.7cm}
...
\begin{center}
\includegraphics[width=12cm]{fig/munimpliesalphanproof.pdf}
\end{center}
\end{proof}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=10cm]{fig/MuNLinha.pdf}
   \end{center}
   \vspace{-0.7cm}
...
not be shown.
\begin{center}
\includegraphics[width=13cm]{fig/MuNLinhaImpliesMuNProof.pdf}
\end{center}
\vspace{-1cm}
\end{proof}
...
\rule{0cm}{2.7cm}
\includegraphics[width=5cm]{fig/translationK0.pdf} &
\includegraphics[width=5cm]{fig/translationRibbonMove.pdf} \\
Translation of $K_0$ into $B_0$ &
Translation of the ribbon move $K_1$ into $B_1$ \\ \hline
\rule{0cm}{2.7cm}
\includegraphics[width=5cm]{fig/translationK2.pdf} &
\includegraphics[width=5cm]{fig/translationK3.pdf} \\
Translation of $K_2$ into $B_2$ &
Translation of $K_3$ into $B_3$ \\ \hline
\multicolumn{2}{|c|}{
      \rule{0cm}{7.4cm} \includegraphics[width=9cm]{fig/MuNLinhaTranslation2.pdf}
} \\
\multicolumn{2}{|c|}{
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics{fig/gBlinkFromBlinkElements.pdf}\\
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=14cm]{fig/Blink2GBlinkExample.pdf}\\
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=6cm]{fig/gBlinkWithoutZigzags.pdf}\\
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=12cm]{fig/DifferentBlinksSameGBlink.pdf}\\
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=11cm]{fig/SphereIsotopy.pdf}
   \end{center}
   \vspace{-0.7cm}
...
The (meta-)blinks shown below induce the same space.
    \begin{center}
        \includegraphics[width=5cm]{fig/BlinkJumpingRopeLemma.pdf}
    \end{center}
\end{Lem}
...
result.
    \begin{center}
        \includegraphics[width=14cm]{fig/BlinkJumpingRopeLemmaProof.pdf}
    \end{center}
\vspace{-1cm}
\end{proof}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=8cm]{fig/linkingMatrix.pdf}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics{fig/qialphabeta.pdf}
   \end{center}
...
%-----------------------------------
    ...
    \begin{figure}[h!]
        \begin{center}
            \includegraphics[width=4cm]{fig/strange.pdf}
        \end{center}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics{fig/gBlinkLabeling.pdf}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=10cm]{fig/blinkWith8Operations.pdf}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=13cm]{fig/dualGBlinksInduceSameSpace.pdf}
   \end{center}
   \vspace{-0.7cm}
...
\multicolumn{1}{|p{4.5cm}|}{\protect \centering change parity (P) and swap face-edges and vertex-edges (FV) \\[0.3cm] \includegraphics{fig/smallGBlinkDual.pdf}} &
\multicolumn{1}{|p{4.5cm}|}{\protect \centering each face becomes a
vertex, each
edge becomes a dual edge with different color \\[0.3cm] \includegraphics{fig/smallBlinkDual.pdf}} &
\multicolumn{1}{|p{4.5cm}|}{\protect \centering overpass one external edge \\[0.3cm] \includegraphics{fig/smallBFLDual.pdf}} \\ \hline
...
\includegraphics{fig/smallGBlinkReflection.pdf}}  &
\multicolumn{1}{|p{4.5cm}|}{\protect \centering
reflect \\[0.3cm] \includegraphics{fig/smallBlinkReflection.pdf}} &
\multicolumn{1}{|p{4.5cm}|}{\protect \centering
reflect and change the crossings  \\[0.3cm]
\includegraphics{fig/smallBFLReflection.pdf}} \\ \hline
...
\includegraphics{fig/smallGBlinkRefDual.pdf}} &
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=14cm]{fig/merging.pdf}
   \end{center}
   \vspace{-0.7cm}
...
are the ends of $b$.
$$\includegraphics[width=5cm]{fig/partialDual.pdf}$$ The right
...
$$\includegraphics[width=10cm]{fig/partialReflection.pdf}$$
...
$$\includegraphics[width=8cm]{fig/partialRefDual.pdf}$$ The third
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=8cm]{fig/smilingFrowningFellow2.pdf}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=14cm]{fig/breakpoint.pdf}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=14cm]{fig/mergingWithDual.pdf}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=12cm]{fig/mergingOnAnyAngleEdge.pdf}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=12cm]{fig/dog.pdf}
   \end{center}
   \vspace{-0.7cm}
