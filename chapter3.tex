...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/BFL2Blink.eps,width=12.5cm}\\
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/BlinksPlaneIsotopy.eps,width=9cm}
   \end{center}
   \vspace{-0.7cm}
   \caption{Blinks}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/mun.eps,width=10cm}
   \end{center}
   \vspace{-0.7cm}
...
ribbon move.
\begin{center}
\psfig{file=fig/heartSmoothing.eps,width=6cm}
\end{center}
\end{lemma}
...
\begin{center}
\psfig{file=fig/heartSmoothingProof.eps,width=12cm}
\end{center}
\vspace{-0.8cm}
\end{proof}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/MuNproof.eps,width=9cm}
   \end{center}
   \vspace{-0.7cm}
...
\begin{center}
\psfig{file=fig/munimpliesalphanproof.eps,width=12cm}
\end{center}
\end{proof}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/MuNLinha.eps,width=10cm}
   \end{center}
   \vspace{-0.7cm}
...
not be shown.
\begin{center}
\psfig{file=fig/MuNLinhaImpliesMuNProof.eps,width=13cm}
\end{center}
\vspace{-1cm}
\end{proof}
...
\rule{0cm}{2.7cm}
\psfig{file=fig/translationK0.eps,width=5cm} &
\psfig{file=fig/translationRibbonMove.eps,width=5cm} \\
Translation of $K_0$ into $B_0$ &
Translation of the ribbon move $K_1$ into $B_1$ \\ \hline
\rule{0cm}{2.7cm}
\psfig{file=fig/translationK2.eps,width=5cm} &
\psfig{file=fig/translationK3.eps,width=5cm} \\
Translation of $K_2$ into $B_2$ &
Translation of $K_3$ into $B_3$ \\ \hline
\multicolumn{2}{|c|}{
      \rule{0cm}{7.4cm} \psfig{file=fig/MuNLinhaTranslation2.eps,width=9cm}
} \\
\multicolumn{2}{|c|}{
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/gBlinkFromBlinkElements.eps}\\
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/Blink2GBlinkExample.eps,width=14cm}\\
   \end{center}
   \vspace{-0.7cm}
...
\item Its vertices are partitioned in $V_0$ and $V_1$ (white and black
vertices of Figures \ref{fig:gblinkFromBlinkElements} and
\ref{fig:Blink2GBlinkExample});

\item vertices in $V_0$ are adjacent by face-edge, vertex-edge and
...
\item each vertex is incident to exactly one face-edge, one
vertex-edge, one angle-edge and one zigzag-edge;

\item each polygon of alternating face-edge and vertex-edge has
...
\item the zigzag-edges are the diagonals of the g-edges connecting
...
\item the 3-regular graph obtained by not considering the zigzag
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/gBlinkWithoutZigzags.eps,width=6cm}\\
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/DifferentBlinksSameGBlink.eps,width=12cm}\\
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/SphereIsotopy.eps,width=11cm}
   \end{center}
   \vspace{-0.7cm}
...
The (meta-)blinks shown below induce the same space.
    \begin{center}
        \psfig{file=fig/BlinkJumpingRopeLemma.eps,width=5cm}
    \end{center}
\end{lemma}
...
result.
    \begin{center}
        \psfig{file=fig/BlinkJumpingRopeLemmaProof.eps,width=14cm}
    \end{center}
\vspace{-1cm}
\end{proof}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/linkingMatrix.eps,width=8cm}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/qialphabeta.eps}
   \end{center}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      %\psfig{file=fig/blinkgraphlbl.\jpgext}
...
\end{figure}
\begin{comment}
{\bf Estende os QIs para blinks desconexos.}
...
%-----------------------------------
    ...
    \begin{figure}[h!]
        \begin{center}
            \psfig{file=fig/strange.eps,width=4cm}
        \end{center}
...
\TODO{Bring back $GBlinkLabel(G,v)$ algorithm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/gBlinkLabeling.eps}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/blinkWith8Operations.eps,width=10cm}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/dualGBlinksInduceSameSpace.eps,width=13cm}
   \end{center}
   \vspace{-0.7cm}
...
\multicolumn{1}{|p{4.5cm}|}{\protect \centering change parity (P) and swap face-edges and vertex-edges (FV) \\[0.3cm] \psfig{file=fig/smallGBlinkDual.eps}} &
\multicolumn{1}{|p{4.5cm}|}{\protect \centering each face becomes a
vertex, each
edge becomes a dual edge with different color \\[0.3cm] \psfig{file=fig/smallBlinkDual.eps}} &
\multicolumn{1}{|p{4.5cm}|}{\protect \centering overpass one external edge \\[0.3cm] \psfig{file=fig/smallBFLDual.eps}} \\ \hline
...
\psfig{file=fig/smallGBlinkReflection.eps}}  &
\multicolumn{1}{|p{4.5cm}|}{\protect \centering
reflect \\[0.3cm] \psfig{file=fig/smallBlinkReflection.eps}} &
\multicolumn{1}{|p{4.5cm}|}{\protect \centering
reflect and change the crossings  \\[0.3cm]
\psfig{file=fig/smallBFLReflection.eps}} \\ \hline
...
\psfig{file=fig/smallGBlinkRefDual.eps}} &
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/merging.eps,width=14cm}
   \end{center}
   \vspace{-0.7cm}
...
are the ends of $b$.
$$\psfig{file=fig/partialDual.eps,width=5cm}$$ The right
...
$$\psfig{file=fig/partialReflection.eps,width=10cm}$$
...
$$\psfig{file=fig/partialRefDual.eps,width=8cm}$$ The third
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/smilingFrowningFellow2.eps,width=8cm}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/breakpoint.eps,width=14cm}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/mergingWithDual.eps,width=14cm}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/mergingOnAnyAngleEdge.eps,width=12cm}
   \end{center}
   \vspace{-0.7cm}
...
\TODO{Bring back $CompareTrees(G,v)$ algorithm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/dog.eps,width=12cm}
   \end{center}
   \vspace{-0.7cm}
