...
\begin{center}
\includegraphics[width=14cm]{fig/euclids.pdf}
\end{center}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=8cm]{fig/blink2GemAlgorithm.pdf}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=8cm]{fig/spacePresentationsSchema.pdf}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics{fig/coinDrawing.pdf}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[h!tp]
   \begin{center}
      \leavevmode
      \includegraphics[width=14cm]{fig/circlePacking.pdf}
   \end{center}
   \vspace{-0.7cm}
...
db(C,cols=10,rows=4.pdf="blinks.pdf")
// produces the link drawings
dl(C,cols=10,rows=4.pdf="links.pdf")
\end{verbatim}
\end{footnotesize}
\end{minipage}
\end{center}
...
\begin{figure}[h!tp]
   \begin{center}
      \leavevmode
      \includegraphics{fig/blinkLanguageExample.pdf}
   \end{center}
   \vspace{-0.7cm}
