...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/unavoidableSetPipeline.eps,width=12cm}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/blockGeneration.eps,width=12cm}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/unnecessaryGBlinkStructure.eps,width=12cm}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/qiFailure.eps,width=15cm}
   \end{center}
   \vspace{-0.7cm}
...
\TODO{Bring back algorithm SearchInTSClass}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/subgraphs.eps,width=15cm}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[h!tp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/compositeSpaces.eps,width=16cm}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[h!tp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/gblinksForS1xS2inU.eps,width=14cm}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[h!tp]
   \begin{center}
      \leavevmode
      %\psfig{file=fig/primeSpace487Representants.eps,width=14.5cm}
      \psfig{file=fig/primeSpace487Representants.eps,width=15cm}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[h!tp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/primeSpace487RepresentantLinks.eps,width=15cm}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/nonTrivialGreenBlocks.eps}
   \end{center}
   \vspace{-0.7cm}
