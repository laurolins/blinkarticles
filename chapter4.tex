...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics{fig/tsmoves.pdf}\\
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=10cm]{fig/umove.pdf}\\
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=10cm]{fig/The-12-8-Move.pdf}\\
   \end{center}
   \vspace{-0.7cm}
...
\begin{center}
      \includegraphics[width=10cm]{fig/theTwoCrossings.pdf}
\end{center}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=15cm]{fig/poincareGemBlink.pdf}
   \end{center}
   \vspace{-0.7cm}
...
$J^\star(B)$. Take a neighborhood $\C_e \times [0,.pdfilon]$ in
$|J|$ identify $\C_e \times \{.pdfilon/2\}\equiv \C_e$ and define
$\C_\alpha = \C_e \times \{0\}$ and $\C_\gamma = \C_e \times
\{.pdfilon\}$. Let $K$ be a simplicial complex which is a refinement
of $J^\star$ containing both $\C_\alpha$ and $\C_\gamma$ as
sub-complexes. We observe that $|J|=|J^\star|=|K|$ and that
vertices $r$ and $s$ of gem $J$ are in $\C_e \times [0,.pdfilon]$.


\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=12cm]{fig/cylinderInEdge.pdf}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics{fig/gBlink2gem.pdf}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=9cm]{fig/gBlinkAndGem.pdf}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=14cm]{fig/breakpairAndTorus.pdf}\\
   \end{center}
   \vspace{-0.7cm}
...
$T^2_{ef}$. Consider an $.pdfilon$-neighborhood $T^2 \times
[0,.pdfilon]$ of $T^2 \subset K$ so that $T^2 \equiv T^2 \times
\{.pdfilon/2\}$. If we now remove $T^2 \equiv T^2 \times
\{0,.pdfilon\}$ from $|K|$ then we have two disjoint spaces $|K_A|$
with boundary $\C_\alpha + \C_\beta = T_{\alpha\beta}^2 \equiv T^2
\times \{0\}$ and  $|K_B|$ with boundary $\C_\gamma + \C_\delta =
T_{\gamma\delta}^2 \equiv T^2 \times \{.pdfilon\}$ as shown in
Figure~\ref{fig:breakpairAndTorus}. It follows that
\begin{equation}\label{eq:tripartition1} |K| = |K_A| \cup \left(T^2
\times [0,.pdfilon]\right)\ \cup\ |K_B|,\end{equation} with
\begin{equation}\label{eq:tripartition2} |K_A| \cap \left(T^2 \times
[0,.pdfilon]\right) = T_{\alpha\beta}^2 , \hspace {8mm} \left(T^2
\times [0,.pdfilon] \cap |K_B| \right) = T^2_{\gamma\delta}, \hspace
...
finishes at $(-x,-y,.pdfilon)$. Note that any two vertical segments
in $F$ whose distance is an integer are identified. Clearly $F'
\approx \IS^1 \times \IS^1 \times [0,.pdfilon]$.
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=15cm]{fig/filme.pdf}\\
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=15cm]{fig/inThreeParts.pdf}\\
   \end{center}
   \vspace{-0.7cm}
...
$T^2 \times [0,.pdfilon]$ onto $F'$ and $\widetilde{h}$ be a fixed
homeomorphism which maps $\widetilde{T^2} \times [0,.pdfilon]$ onto
...
[0,.pdfilon]\right)\ \cup\ |K_B|, \hspace{3mm} |\widetilde{K}| =
|K_A| \cup \left(\widetilde{T_2} \times [0,.pdfilon]\right)\ \cup\
|-K_B|, \hspace{3mm} |K_A| \cap |K_B| = \emptyset.$$ with
\begin{equation}
\label{eq:tripartition4} |K_A| \cap \left( T^2 \times
[0,.pdfilon]\right) = T_{\alpha\beta}^2, \hspace {8mm} \left({T^2}
\times [0,.pdfilon]\right) \cap |K_B| = T_{\gamma\delta}^2,
\end{equation}
$$ |K_A| \cap \left( \widetilde{T^2} \times
[0,.pdfilon]\right) = T_{\alpha\beta}^2, \hspace {8mm} \left(
\widetilde{T^2} \times [0,.pdfilon]\right) \cap |-K_B| =
-T_{\gamma\delta}^2.$$ Define the map $\rho$ from $|K|$ to
$|\widetilde{K}|$ to be the identity in $|K_A| \cup |K_B|$. For $x
\in T^2 \times [0,.pdfilon]$, define $\rho(x) = \left[(\,
\widetilde{h}\, )^{-1}\ {\circ} \ \mu\ {\circ} \ h'
\right](x) \in \widetilde{T^2} \times [0,.pdfilon]$. Map $\rho$ is
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \includegraphics[width=12cm]{fig/spaceToroidalBoundary.pdf}\\
   \end{center}
   \vspace{-0.7cm}
