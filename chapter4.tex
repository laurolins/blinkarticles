...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/umove.eps,width=10cm}\\
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/The-12-8-Move.eps,width=10cm}\\
   \end{center}
   \vspace{-0.7cm}
...
\begin{center}
      \psfig{file=fig/theTwoCrossings.eps,width=10cm}
\end{center}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/poincareGemBlink.eps,width=15cm}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/cylinderInEdge.eps,width=12cm}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/gBlinkAndGem.eps,width=9cm}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/breakpairAndTorus.eps,width=14cm}\\
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/filme.eps,width=15cm}\\
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/inThreeParts.eps,width=15cm}\\
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/spaceToroidalBoundary.eps,width=12cm}\\
   \end{center}
   \vspace{-0.7cm}
