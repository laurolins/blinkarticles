...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/sevenBridges.eps,width=5cm}
      \hspace{1cm}
      \psfig{file=fig/sevenBridgesWrongWalk.eps,width=5cm} \\
   (A) \hspace{5.5cm} (B)\\
   \end{center}
   \vspace{-0.7cm}
...
\begin{center}
\it \large A space in this work is the same as \linebreak a
...
\begin{figure}[htp]
   \begin{center}
\begin{tabular}{ccccc}
      \psfig{file=fig/link0.1.eps   ,width=2.5cm} &
      \psfig{file=fig/link3.1.eps   ,width=2.5cm} &
      \psfig{file=fig/link4.1.eps   ,width=2.5cm} &
      \psfig{file=fig/2rings.eps    ,width=2.5cm} &
      \psfig{file=fig/borromean.eps ,width=2.5cm} \\
      (A) & (B) & (C) & (D) & (E) \\
\end{tabular}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
\begin{tabular}{ccccc}
      \psfig{file=fig/link0.1d.eps   ,width=2.5cm} &
      \psfig{file=fig/link3.1d.eps   ,width=2.5cm} &
      \psfig{file=fig/link4.1d.eps   ,width=2.5cm} &
      \psfig{file=fig/2ringsd.eps    ,width=2.5cm}  &
      \psfig{file=fig/borromeand.eps ,width=2.5cm} \\
      (A) & (B) & (C) & (D) & (E) \\
\end{tabular}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
   \psfig{file=fig/linkDiagramElements.eps, width=10cm}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
   \psfig{file=fig/exampleOfAmbientIsotopicKnots.eps, width=10cm}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
   \psfig{file=fig/ReidemeisterMoves.eps, width=12.7cm}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
   \psfig{file=fig/orientedLinks.eps, width=9cm}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
   \psfig{file=fig/blackboardFramedLink.eps, width=12cm}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
   \psfig{file=fig/unknotWithMeridian.eps,width=7cm}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
   \psfig{file=fig/surgery.eps, width=9cm}
   \end{center}
   \vspace{-0.7cm}
   \caption{ Oriented links}
   \label{fig:surgery}
...
{\bf Linking Number, Writhe} Any framed link with integral framing
...
known {\bf (cite this result)}, any space has a framed link
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/kauffmancalculus.eps,width=15cm}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/exampleBFLCalculus.eps, width=12cm}
   \end{center}
   \vspace{-0.7cm}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/ribbonmove.eps, width=8.5cm}
   \end{center}
   \vspace{-0.7cm}
...
space.
\begin{center}
      \psfig{file=fig/whitneytrickresult.eps, width=8cm}
\end{center}
...
transformation
\begin{center}
\psfig{file=fig/whitneytrickproof.eps, width=12cm}.
\end{center}
...
\begin{center}
\psfig{file=fig/ribbonmoveproof.eps}
\end{center}
\vspace{-0.8cm}
\end{proof}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/someNotation.eps, width=13cm}
   \end{center}
   \vspace{-0.7cm}
...
\begin{center}
\psfig{file=fig/ncurland2pibox.eps}
\end{center}
\end{lemma}
\begin{proof}
Generalization of the following case where $n = 3$.
\begin{center}
\psfig{file=fig/ncurland2piboxProof2.eps, width=12cm}
\end{center}
\vspace{-0.8cm}
\end{proof}
...
\begin{center}
\psfig{file=fig/istrandistrands.eps, width=9cm}
\end{center}
\end{lemma}
\begin{proof}
This proof is taken from \cite{Kauffman1991}.
\begin{center}
\psfig{file=fig/istrandistrandsproof.eps,width=10cm}
\end{center}
...
\begin{center}
\psfig{file=fig/ribbonmoveimpliesk5proof.eps,width=9cm}
\end{center}
...
\begin{figure}[htp]
   \begin{center}
      \leavevmode
      \psfig{file=fig/BFLcalculusK1.eps, width=12.5cm}
   \end{center}
   \vspace{-0.7cm}
...
\begin{center}
\psfig{file=fig/passingWallLemma.eps}
\end{center}
\end{lemma}
\begin{proof}
...
\begin{center}
\psfig{file=fig/passingCrossLemma.eps}
\end{center}
\end{lemma}
...
\begin{center}
\psfig{file=fig/passingCrossLemmaProof.eps}
\end{center}
\end{proof}
...
\begin{center}
\psfig{file=fig/jumpingRopeLemma.eps}
\end{center}
\end{lemma}
\begin{proof} Follow the picture below. It proves that the first two
...
\begin{center}
\psfig{file=fig/jumpingRopeLemmaProof.eps}
\end{center}
\vspace{-0.8cm}
\end{proof}
